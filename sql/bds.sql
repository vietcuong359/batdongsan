...
CREATE TABLE `bds_khac` (
  `ma_bds_khac` int(10) unsigned NOT NULL,
  PRIMARY KEY (`ma_bds_khac`),
  CONSTRAINT `fk_bds_khac_Tin1` FOREIGN KEY (`ma_bds_khac`) REFERENCES `tin` (`ma_tin`) ON DELETE CASCADE ON UPDATE CASCADE
